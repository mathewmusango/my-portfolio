...
green `build`; everyone else is bound by both rules.
...
| Actor | Outcome |
| --- | --- |
| collaborator (`kizingainc`) | 🔴 rejected — "Cannot create ref due to creations being restricted" + "Required status check 'build' is expected" |
